...
//        this.class.getSystemClassLoader();
        ...
        String dir = "e:\\test\\";
        ClassLoaderLK cl = new ClassLoaderLK(currentClassloader, dir);

        System.out.println();
        System.out.println("currentClassloader is " + currentClassloader);
        System.out.println();
        String name = "com.hao.classloader.AbcBean.class";
        name = "com.hao.classloader.AbcBean";
        try {
